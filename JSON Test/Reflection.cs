...
namespace JSON_Test
{
    ...
    {
        // 리플렉션(Reflection) : 코드에서 객체의 형식(Type)에 저장된 정보를 찾는 매커니즘
        // 1. 리플렉션이 무엇인지 어디에 유용한지
        // (1) 클래스를 생성할 떄 메타데이터에 클래스의 정보를 담습니다. 리플렉션은 이 메타데이터 정보를 이용하여 데이터 저장된 모든 정보를 프로그래머가
        // 사용할 수 있게 도와주는 기능을 합니다.
        ...
        // 코드를 이해하고 사용하는 것이 직관적이지 않다.(사용하기 어렵다.)
