...
namespace JSON_Test
{
    [History("고병석", Version = 1.00, ChangeValue = "첫 애트리뷰트 사용")]
    public class AttributeTest
    {
        // 애트리뷰 : 코드에 대한 부가 정보를 저장하는 메타 데이터에 내용을 기록하고 읽을 수 있도록 하는 기능
        ...
        // 1. obsolete 애트리뷰트 : 이 애트리뷰트가 선언된 멤버는 사용을 할 떄 경고, 에러를 발생시키게 합니다.
        [Obsolete]
